...
//      'headers' => $response->getHeaders(),
      'page' => $response->getHeaderLine('X-Page'),
      'next_page' => $response->getHeaderLine('X-Next-Page'),
      'per_page' => $response->getHeaderLine('X-Per-Page'),
      'total' => $response->getHeaderLine('X-Total'),
      'total_pages' => $response->getHeaderLine('X-Total-Pages'),
    ];

    if (!empty($params['with_headers'])) {
      return $result;
    }
  ...
  protected function createOptionsResolver(): OptionsResolver
  {
    ...
    $resolver->setDefined('with_headers')
             ->setAllowedTypes('with_headers', 'bool');
